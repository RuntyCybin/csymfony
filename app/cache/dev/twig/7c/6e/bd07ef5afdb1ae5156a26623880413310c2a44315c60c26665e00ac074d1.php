...
class __TwigTemplate_7c6ebd07ef5afdb1ae5156a26623880413310c2a44315c60c26665e00ac074d1 extends Twig_Template
{
    ...
    {
        $__internal_2422bfc6dd7af9fe11cf48f1368d303857516f50df13e83ca65459a01b4a6d83 = $this->env->getExtension("native_profiler");
        $__internal_2422bfc6dd7af9fe11cf48f1368d303857516f50df13e83ca65459a01b4a6d83->enter($__internal_2422bfc6dd7af9fe11cf48f1368d303857516f50df13e83ca65459a01b4a6d83_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "TwigBundle:Exception:exception.html.twig"));
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        <div class=\"text-exception\">
            ...
            <h1>
                ";
        // line 12
        echo $this->env->getExtension('code')->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_template_get_attributes($this, (isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "message", array()), "html", null, true)));
        echo "
            </h1>
        ...
        echo " - ";
        echo $this->env->getExtension('code')->abbrClass(twig_template_get_attributes($this, (isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "class", array()));
        echo "
            </div>

            ";
        // line 19
        $context["previous_count"] = twig_length_filter($this->env, twig_template_get_attributes($this, (isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "allPrevious", array()));
        // line 20
        echo "            ";
        if ((isset($context["previous_count"]) ? $context["previous_count"] : $this->getContext($context, "previous_count"))) {
            ...
            $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, (isset($context["exception"]) ? $context["exception"] : $this->getContext($context, "exception")), "allPrevious", array()));
            foreach ($context['_seq'] as $context["i"] => $context["previous"]) {
                // line 24
                echo "                            <li>
                                ";
                // line 25
                echo $this->env->getExtension('code')->abbrClass(twig_template_get_attributes($this, $context["previous"], "class", array()));
...
";
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 56
            if (twig_template_get_attributes($this, (isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "counterrors", array())) {
                // line 57
                echo "                <div class=\"error-count\">
                    <span>
                        ";
                // line 59
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, (isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "counterrors", array()), "html", null, true);
                echo " error";
                echo (((twig_template_get_attributes($this, (isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "counterrors", array()) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(array("logs" => twig_template_get_attributes($this, (isset($context["logger"]) ? $context["logger"] : $this->getContext($context, "logger")), "logs", array())));
            // line 67
            echo "        </div>
    </div>
";
...
";
        ...
        $__internal_2422bfc6dd7af9fe11cf48f1368d303857516f50df13e83ca65459a01b4a6d83->leave($__internal_2422bfc6dd7af9fe11cf48f1368d303857516f50df13e83ca65459a01b4a6d83_prof);
