...
use Modules\UserBundle\Entity\Post;
use Modules\UserBundle\Form\PostType;
...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ModulesUserBundle:Post')->findAll();
     ...
     * @Route("/", name="_create")
     * @Method("POST")
     * @Template("ModulesUserBundle:Post:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ModulesUserBundle:Post')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ModulesUserBundle:Post:edit.html.twig")
     */
